...
const FIXTURE_SMOKE_CASES: Case[] = [
  ...
  makeCase({
    ...
    contract: [
      ...
      'visible static heading: Contact details',
    ],
    task: 'Assume Agent Device Tester is on the Checkout form tab. Plan the fallback commands to focus the Full name field, blur the iOS keyboard through the visible static heading, and verify the keyboard closes and field remains visible.',
    outputs: [
      /field-name/i,
      /Contact details/i,
