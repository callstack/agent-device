...
function testSlowProviderScenario(name: string, run: () => Promise<void>): void {
  test(name, run, PARALLEL_PROVIDER_SCENARIO_TIMEOUT_MS);
}

testSlowProviderScenario(
  'Provider-backed integration iOS Settings flow uses scripted simctl and runner providers',
  async () => {
