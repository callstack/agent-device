// The three ratcheted measurements (R6 type-spine inversions, R9 largest type cycle, R10's R7
// ownership pressure) and where their reference numbers come from: the merge-base with
// origin/main, measured by the same functions that measure the working tree. Growth fails, a
// shrink needs no edit, and no recorded number can sit above what main actually holds.
//
