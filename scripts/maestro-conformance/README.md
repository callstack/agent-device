...
only to be _parsed_ — they name a fictional `com.example.app` and elements that
...
known gap, and only _undeclared_ divergences fail.
...
A green run still prints what it is _not_ proving.
