...
export const CHECK_CATALOG: readonly CheckSpec[] = [
  ...
  gate('repo-history', 'Rename-resolved history model', 'repo-history:test'),
  gate('coupling', 'Change-coupling report model', 'coupling:test'),
  gate('legibility', 'Placement-legibility report model', 'legibility:test'),
