...
// ---------------------------------------------------------------------------
// ADR 0012 decision 3: target-v1 evidence is computed only while the session
// is being recorded, lands on the recorded action (never the public
// response), and the raw resolved node/tree never reaches either the client
// or session history.
// ---------------------------------------------------------------------------
