      ...
      await handleSessionStateCommands({
        ...
        inspectFacts: async () =>
          createUnavailablePlatformRuntimeFacts(device, localRuntimeOwner('apple'), {
            ...
            keyboard: { available: false, reason: 'owner-capability-missing' },
            clipboard: { available: false, reason: 'owner-capability-missing' },
            systemButton: { available: false, reason: 'owner-capability-missing' },
            fold: { available: false, reason: 'owner-capability-missing' },
            triggerAppEvent: { available: false, reason: 'owner-capability-missing' },
            settings: { available: false, reason: 'owner-capability-missing' },
      ...
      await handleSessionStateCommands({
        ...
        inspectFacts: async () =>
          createUnavailablePlatformRuntimeFacts(device, localRuntimeOwner('web'), {
            ...
            keyboard: { available: false, reason: 'unsupported-platform-leaf' },
            clipboard: { available: false, reason: 'unsupported-platform-leaf' },
            systemButton: { available: false, reason: 'unsupported-platform-leaf' },
            fold: { available: false, reason: 'unsupported-platform-leaf' },
            triggerAppEvent: { available: false, reason: 'unsupported-platform-leaf' },
            settings: { available: false, reason: 'unsupported-platform-leaf' },
