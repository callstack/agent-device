      ...
      await handleSessionStateCommands({
        ...
        inspectFacts: async () =>
          createUnavailablePlatformRuntimeFacts(device, localRuntimeOwner('apple'), {
            ...
            gesture: { available: false, reason: 'owner-capability-missing' },
            scroll: { available: false, reason: 'owner-capability-missing' },
            typeText: { available: false, reason: 'owner-capability-missing' },
            touch: { available: false, reason: 'owner-capability-missing' },
            elementText: { available: false, reason: 'owner-capability-missing' },
            back: { available: false, reason: 'owner-capability-missing' },
            home: { available: false, reason: 'owner-capability-missing' },
            orientation: { available: false, reason: 'owner-capability-missing' },
            tvRemote: { available: false, reason: 'owner-capability-missing' },
            keyboardStatus: { available: false, reason: 'owner-capability-missing' },
            keyboardDismiss: { available: false, reason: 'owner-capability-missing' },
            keyboardEnter: { available: false, reason: 'owner-capability-missing' },
            readClipboard: { available: false, reason: 'owner-capability-missing' },
            ...
            audioProbeCapture: { available: false, reason: 'owner-capability-missing' },
            audioProbeQuery: { available: false, reason: 'owner-capability-missing' },
      ...
      await handleSessionStateCommands({
        ...
        inspectFacts: async () =>
          createUnavailablePlatformRuntimeFacts(device, localRuntimeOwner('web'), {
            ...
            gesture: { available: false, reason: 'unsupported-platform-leaf' },
            scroll: { available: false, reason: 'unsupported-platform-leaf' },
            typeText: { available: false, reason: 'unsupported-platform-leaf' },
            touch: { available: false, reason: 'unsupported-platform-leaf' },
            elementText: { available: false, reason: 'unsupported-platform-leaf' },
            back: { available: false, reason: 'unsupported-platform-leaf' },
            home: { available: false, reason: 'unsupported-platform-leaf' },
            orientation: { available: false, reason: 'unsupported-platform-leaf' },
            tvRemote: { available: false, reason: 'unsupported-platform-leaf' },
            keyboardStatus: { available: false, reason: 'unsupported-platform-leaf' },
            keyboardDismiss: { available: false, reason: 'unsupported-platform-leaf' },
            keyboardEnter: { available: false, reason: 'unsupported-platform-leaf' },
            readClipboard: { available: false, reason: 'unsupported-platform-leaf' },
            ...
            audioProbeCapture: { available: false, reason: 'unsupported-platform-leaf' },
            audioProbeQuery: { available: false, reason: 'unsupported-platform-leaf' },
