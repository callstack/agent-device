...
// structural wrappers, Android's status-bar/IME systemui strip — must be excluded or
// it truncates the actionable target out. This sibling covers the whole chrome
