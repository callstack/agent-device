 ...
 * (`buildAncestryChain`/`computeScrollRegionKey`, `@agent-device/ad-script/target-evidence`)
...
import { computeScrollRegionKey, scrollRegionKeysEqual } from '@agent-device/ad-script/target-evidence';
