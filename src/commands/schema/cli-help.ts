...
Changing the pose:
  ...
  For timed motion use fold --keyframes '[{"atMs":0,"angle":0},{"atMs":1667,"angle":160},{"atMs":3333,"angle":100},{"atMs":5000,"angle":180}]'. Supply either pose or keyframes. Use 2–64 frames starting at 0ms, strictly increasing integer timestamps up to 60000ms, and finite angles in 0–180 degrees. Motion is linearly interpolated at approximately 60Hz; repeat an angle to hold it. The final timestamp is motion duration, excluding preparation and final verification. The final angle must agree within 0.5 degrees; interior angles must also settle. Cancellation stops at the current angle. Re-snapshot after completion or interruption.
