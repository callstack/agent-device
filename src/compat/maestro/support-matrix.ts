...
export const MAESTRO_COMPAT_LIMITATIONS = [
  ...
  'Environment: flow env is the default, AD_VAR_* overrides it, and CLI -e KEY=VALUE wins over both. Failure diagnostics render resolved targets and paths but never inputText payloads; do not put secrets in diagnostic identifiers.',
