...
After direct-provider connect:
  ...
  A new Doublespeed simulator has no user app either. Run install <bundle-id> <app-path-or-url> first; install allocates the simulator, then open launches the installed id.
