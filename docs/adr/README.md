...
| [0016 Active-Session Script Publication](0016-active-session-replay-publication.md) | publishing an armed open-to-destination `.ad` script without closing its live session |
