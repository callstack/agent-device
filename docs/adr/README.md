...
| [0016 Active-Session Replay Publication](0016-active-session-replay-publication.md) | publishing an armed open-to-destination `.ad` recording without closing its live session |
