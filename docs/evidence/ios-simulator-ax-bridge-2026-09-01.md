...
- Current integrated #2189 prerequisite head: `80ed800a1991d65f129e16c5165f33ea3169da04` (`codex/2189-ios-snapshot-baselines`, PR #2204). This prerequisite-only update followed the evidence revision; the run produced no acquisition cells or latency claims.
