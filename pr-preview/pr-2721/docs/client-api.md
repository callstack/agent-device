...
Building an agent? Start with the dedicated [AI SDK](/agent-device/pr-preview/pr-2721/docs/ai-sdk.md) or [Eve](/agent-device/pr-preview/pr-2721/docs/eve.md) integration.
...
Use `client.sessions.artifacts({ provider, providerSessionId })` with `closed.provider?.providerSessionId` to fetch provider-hosted video and log URLs after close. See the [BrowserStack](/agent-device/pr-preview/pr-2721/docs/browserstack.md), [AWS Device Farm](/agent-device/pr-preview/pr-2721/docs/aws-device-farm.md), and [Limrun](/agent-device/pr-preview/pr-2721/docs/limrun.md) guides for provider-specific setup.
