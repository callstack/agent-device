...
- On iOS, `appstate` is unavailable: the Apple target answers no sessionless foreground probe. Whether
  ...
  [`targetActivation` disclosure](/agent-device/pr-preview/pr-2837/docs/commands.md#foreground-repairs-on-ios).
- For remote `connect --remote-config` sessions, see [Commands](/agent-device/pr-preview/pr-2837/docs/commands.md#remote-metro-workflow).
...
For replay scripts and deterministic E2E guidance, see [Replay & E2E](/agent-device/pr-preview/pr-2837/docs/replay-e2e.md).
