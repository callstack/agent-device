...
- Full command reference: [Commands](/agent-device/pr-preview/pr-2737/docs/commands.md)
- Node.js observability APIs: [Node.js API](/agent-device/pr-preview/pr-2737/docs/client-api.md)
- Session behavior and lifecycle: [Sessions](/agent-device/pr-preview/pr-2737/docs/sessions.md)
