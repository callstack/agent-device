...
Use [AI Agent Setup](/agent-device/pr-preview/pr-2345/docs/agent-setup.md) for Cursor, Codex, Claude Code, Windsurf, Cline, Goose, skills, and MCP setup. Use [Commands](/agent-device/pr-preview/pr-2345/docs/commands.md) for detailed command groups and platform behavior.
...
- Install the CLI: [Installation](/agent-device/pr-preview/pr-2345/docs/installation.md)
- Set up an agent client: [AI Agent Setup](/agent-device/pr-preview/pr-2345/docs/agent-setup.md)
- Run the first commands: [Quick Start](/agent-device/pr-preview/pr-2345/docs/quick-start.md)
- Inspect all command groups: [Commands](/agent-device/pr-preview/pr-2345/docs/commands.md)
- Collect runtime evidence: [Debugging & Profiling](/agent-device/pr-preview/pr-2345/docs/debugging-profiling.md)
- Record deterministic flows: [Replay & E2E](/agent-device/pr-preview/pr-2345/docs/replay-e2e.md)
