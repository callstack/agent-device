...
- Use [BrowserStack](/docs/browserstack) or [AWS Device Farm](/docs/aws-device-farm) when agents need hosted device sessions from CI without interactive login.
