...
features:
  ...
  - title: React Native internals
    details: Use agent-device react-devtools for component trees and render profiles, and agent-device agent-cdp for React Native JS heap snapshots, diffs, and leak retainers.
---
