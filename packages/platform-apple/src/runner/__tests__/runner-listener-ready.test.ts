...
// The scanner has read the runner's log file since #2681, which merged what used to be two process
// streams into one ordered byte sequence. Chunk boundaries still matter; stream boundaries no longer
// exist.
